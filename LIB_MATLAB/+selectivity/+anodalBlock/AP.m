classdef AP
    %AP  Class that detect AP in a fiber
    % types :    
    ...
    methods
        function o = findAP(o,Vm,t,Ve, varargin)
           ...
           display(['Type détecté : ' num2str(o.type)]);
