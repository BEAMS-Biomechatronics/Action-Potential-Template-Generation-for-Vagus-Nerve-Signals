function findProgressiveWF(hasToFindCurrent1)
    ...
    I0                          = amp(3:nVarOptim+2)*current1;
 
    % configure optimzation
    options = psoptimset('PlotFcn',{@psplotbestf, @psplotmeshsize, @psplotfuncount, @psplotbestx} , 'Display', 'iter', 'TolX', TolX, 'MaxMeshSize', MaxMeshSize);
    ...
    costFindProgressiveWFSimplified = @(I) costFindProgressiveWF(cible, I, times, amp);
